...
videos:
  - id: V08
    title: Import assets + keep an assets folder
    minutes: 4
    outcome: Bring in sprites/backdrops without chaos.
  - id: V10
    title: Costumes + timing (animation loop)
    minutes: 4
    outcome: Use timing to control a scene.
submission:
  type: file
  accepted:
    - .sb3
  naming: S07_scene_v1.sb3
done_looks_like:
  - Two characters appear.
  - Something changes (movement, costume, or backdrop).
  - Scene has an ending cue.
help:
  quick_fixes:
