...
### V13 — Start screen + instructions (5 min)
**After this you can:** Create a beginning that explains rules.
...
- [ ] Create a start screen backdrop (title + controls + goal).
- [ ] Gate game start behind a key press or click.
- [ ] Add a credits line (chosen name only).
- [ ] Test: restart twice to ensure it behaves.
- [ ] Download as `S11_final_v1.sb3` and upload.

**Stop point:** If a stranger can start and play, you’re done.

## Submit

Upload: `S11_final_v1.sb3` (.sb3)
