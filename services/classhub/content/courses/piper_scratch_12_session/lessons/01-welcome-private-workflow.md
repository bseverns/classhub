...
**After this you can:** Upload work privately and reload it next time.

## Do

- [ ] Open Scratch (web or app).
- [ ] Make one tiny change (move the sprite).
- [ ] Download as `S01_test_save_v1.sb3`.
- [ ] Upload the file to the LMS assignment.
- [ ] Re-open it once to prove you can resume work.

**Stop point:** If you downloaded `S01_test_save_v1.sb3`, you are on track.

## Submit

Upload: `S01_test_save_v1.sb3` (.sb3)
