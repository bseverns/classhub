...
videos:
  ...
  - id: V09
    ...
    minutes: 4
    outcome: Share privately and keep control.
submission:
  type: text
  accepted:

  naming: Reflection + optional screenshot
done_looks_like:
  - You submitted your final `.sb3` privately.
  - You wrote a reflection.
  - You chose (or declined) public sharing intentionally.
help:
  quick_fixes:
