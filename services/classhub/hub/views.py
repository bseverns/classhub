...
def lesson_asset_download(request, asset_id: int):
    ...
    filename = _safe_filename((asset.original_filename or file_path.name or "asset").strip()[:255])
...
def _normalize_optional_slug_tag(raw: str) -> str:
    # Keep optional course/lesson tags URL-safe for future linking/filtering.
