...
urlpatterns = [
    ...
    path("api/v1/teacher/rbac/simulate", views.api_teacher_rbac_simulate),

    # Student flow (class-code login and classroom page).
    path("", views.index),
    path("privacy", views.privacy_policy),
    path("trust", views.trust_page),
    ...
    path("teach/teacher-account/set-active", views.teach_set_teacher_account_active),
    path("teach/teacher-account/set-superuser", views.teach_set_teacher_account_superuser),
    path("teach/teacher-account/reset-password", views.teach_reset_teacher_account_password),
    path("teach/teacher-account/resend-invite", views.teach_resend_teacher_invite),
    ...
    path("teach/class-organization/set", views.teach_set_class_organization),
    path("teach/org/<int:org_id>/rename", views.teach_rename_organization),
    ...
    path("teach/rbac/custom-role/upsert", views.teach_upsert_custom_role),
    path("teach/rbac/custom-role/capability/upsert", views.teach_upsert_custom_role_capability),
    path("teach/rbac/custom-role/assignment/upsert", views.teach_upsert_custom_role_assignment),
    path("teach/rbac/change-request/review", views.teach_review_rbac_change_request),
    ...
    path("teach/course/<slug:course_slug>/lesson/<slug:lesson_slug>/edit", views.teach_edit_override_lesson),
    ...
    path("teach/class/<int:class_id>/support-tag/add", views.teach_add_support_tag),
    path("teach/class/<int:class_id>/support-tag/remove", views.teach_remove_support_tag),
    path("teach/class/<int:class_id>/resolve-stuck", views.teach_resolve_stuck_flag),
    path("teach/class/<int:class_id>/resolve-delete-request", views.teach_resolve_delete_request),
    ...
    path("teach/class/<int:class_id>/remote-helper-compute", views.teach_set_remote_helper_compute),
    path("teach/class/<int:class_id>/export-helper-remote-snapshot", views.teach_export_class_remote_helper_snapshot),
