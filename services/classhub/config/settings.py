...
TEACHER_2FA_INVITE_MAX_AGE_SECONDS = env.int("TEACHER_2FA_INVITE_MAX_AGE_SECONDS", default=24 * 3600)
...
CLASSHUB_TEACHER_SSO_STATE_MAX_AGE_SECONDS = max(
    env.int("CLASSHUB_TEACHER_SSO_STATE_MAX_AGE_SECONDS", default=600),
    60,
)
...
CLASSHUB_CERTIFICATE_MIN_SESSIONS = max(env.int("CLASSHUB_CERTIFICATE_MIN_SESSIONS", default=8), 1)
CLASSHUB_CERTIFICATE_MIN_ARTIFACTS = max(env.int("CLASSHUB_CERTIFICATE_MIN_ARTIFACTS", default=6), 1)
...
CLASSHUB_TEACHER_LOGIN_RATE_LIMIT_PER_MINUTE = env.int("CLASSHUB_TEACHER_LOGIN_RATE_LIMIT_PER_MINUTE", default=20)
CLASSHUB_TEACHER_2FA_RATE_LIMIT_PER_MINUTE = env.int("CLASSHUB_TEACHER_2FA_RATE_LIMIT_PER_MINUTE", default=10)
CLASSHUB_HELPER_SIGNAL_WINDOW_HOURS = env.int("CLASSHUB_HELPER_SIGNAL_WINDOW_HOURS", default=24)
CLASSHUB_HELPER_SIGNAL_TOP_STUDENTS = env.int("CLASSHUB_HELPER_SIGNAL_TOP_STUDENTS", default=5)
# Optional short-lived cache (seconds) for expensive teacher tracker panels.
...
HELPER_INTERNAL_REMOTE_COMPUTE_STATUS_URL = env(
    "HELPER_INTERNAL_REMOTE_COMPUTE_STATUS_URL",
    default="http://helper_web:8000/helper/internal/remote-compute-status",
).strip()
HELPER_INTERNAL_REMOTE_COMPUTE_CONTROL_URL = env(
    "HELPER_INTERNAL_REMOTE_COMPUTE_CONTROL_URL",
    default="http://helper_web:8000/helper/internal/remote-compute-control",
).strip()
HELPER_INTERNAL_REMOTE_COMPUTE_EVIDENCE_URL = env(
    "HELPER_INTERNAL_REMOTE_COMPUTE_EVIDENCE_URL",
    default="http://helper_web:8000/helper/internal/remote-compute-evidence",
).strip()
HELPER_INTERNAL_REMOTE_COMPUTE_OPERATOR_SNAPSHOT_URL = env(
    "HELPER_INTERNAL_REMOTE_COMPUTE_OPERATOR_SNAPSHOT_URL",
    default="http://helper_web:8000/helper/internal/remote-compute-operator-snapshot",
).strip()
HELPER_INTERNAL_API_TOKEN = env("HELPER_INTERNAL_API_TOKEN", default="").strip()
HELPER_INTERNAL_RESET_TIMEOUT_SECONDS = env.float("HELPER_INTERNAL_RESET_TIMEOUT_SECONDS", default=2.0)
HELPER_INTERNAL_RAG_STATUS_TIMEOUT_SECONDS = env.float("HELPER_INTERNAL_RAG_STATUS_TIMEOUT_SECONDS", default=1.2)
HELPER_INTERNAL_REMOTE_COMPUTE_TIMEOUT_SECONDS = env.float(
    "HELPER_INTERNAL_REMOTE_COMPUTE_TIMEOUT_SECONDS",
    default=2.0,
)
HELPER_INTERNAL_RESET_EXPORT_BEFORE_DELETE = env.bool("HELPER_INTERNAL_RESET_EXPORT_BEFORE_DELETE", default=True)
