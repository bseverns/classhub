...
HELPER_REMOTE_MODE_ACKNOWLEDGED = env.bool("HELPER_REMOTE_MODE_ACKNOWLEDGED", default=False)
...
CLASSHUB_INTERNAL_EVENTS_TIMEOUT_SECONDS = env.float("CLASSHUB_INTERNAL_EVENTS_TIMEOUT_SECONDS", default=0.35)
