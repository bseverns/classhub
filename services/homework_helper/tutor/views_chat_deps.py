...
def build_chat_deps(
    *,
    ...
    retrieve_curriculum_citations_fn,
    is_piper_context_fn,
    is_piper_hardware_question_fn,
    build_piper_hardware_triage_text_fn,
    is_mouse_only_access_question_fn,
    build_mouse_only_adaptation_text_fn,
    is_teamwork_decision_question_fn,
    build_teamwork_decision_text_fn,
    is_class_reentry_privacy_question_fn,
    build_class_reentry_privacy_text_fn,
    is_publish_privacy_question_fn,
    build_publish_privacy_text_fn,
    is_score_condition_debug_question_fn,
    build_score_condition_debug_text_fn,
    is_wellbeing_reset_question_fn,
    build_wellbeing_reset_text_fn,
    build_instructions_fn,
    backend_circuit_is_open_fn,
    llm_backend_requires_acknowledgement_fn,
    ...
    deps = engine_service.ChatDeps(
        ...
        retrieve_curriculum_citations=retrieve_curriculum_citations_fn,
        ...
        is_mouse_only_access_question=is_mouse_only_access_question_fn,
        build_mouse_only_adaptation_text=build_mouse_only_adaptation_text_fn,
        is_teamwork_decision_question=is_teamwork_decision_question_fn,
        build_teamwork_decision_text=build_teamwork_decision_text_fn,
        is_class_reentry_privacy_question=is_class_reentry_privacy_question_fn,
        build_class_reentry_privacy_text=build_class_reentry_privacy_text_fn,
        is_publish_privacy_question=is_publish_privacy_question_fn,
        build_publish_privacy_text=build_publish_privacy_text_fn,
        is_score_condition_debug_question=is_score_condition_debug_question_fn,
        ...
        safeguarding_risk=engine_heuristics.safeguarding_risk,
        build_safeguarding_response=engine_heuristics.build_safeguarding_response,
        ...
        llm_backend_requires_acknowledgement=llm_backend_requires_acknowledgement_fn,
