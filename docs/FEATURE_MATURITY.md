...
5. unattended remote-compute webhook alerts are now available in bounded form, and the Headscale control-plane bundle now includes a replacement-host rehearsal wrapper; the remaining hardening proof step is running and logging a real blank-host restore drill
...
- [CSP_STRICT_MIGRATION_PLAN.md](CSP_STRICT_MIGRATION_PLAN.md)
