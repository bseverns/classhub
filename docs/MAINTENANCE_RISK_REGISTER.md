...
- Evidence:
  ...
  - baseline shell sizes remain tracked: `services/classhub/templates/teach_home.html` is 81 lines; `services/classhub/templates/teach_class.html` is 78 lines; `services/classhub/hub/views/teacher_parts/roster_class.py` is 82 lines after split, with extracted endpoint logic in `services/classhub/hub/views/teacher_parts/roster_class_dashboard.py` (148 lines) and `services/classhub/hub/views/teacher_parts/roster_class_controls.py` (295 lines)
