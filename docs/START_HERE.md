...
- Partner/privacy boundary briefing (non-legal): [LEGAL_AND_PARTNER_NOTES.md](LEGAL_AND_PARTNER_NOTES.md)
...
| Teacher / school staff | [TEACHER_DOCS_JOURNEY.md](TEACHER_DOCS_JOURNEY.md) | [NON_DEVELOPER_GUIDE.md](NON_DEVELOPER_GUIDE.md), [LESSON_OVERRIDES.md](LESSON_OVERRIDES.md), [TEACHER_PORTAL.md](TEACHER_PORTAL.md), [TEACHER_COURSE_IMPORT.md](TEACHER_COURSE_IMPORT.md) |
| Operator / admin | [DAY1_DEPLOY_CHECKLIST.md](DAY1_DEPLOY_CHECKLIST.md) | [SECURITY.md](SECURITY.md), [RUNBOOK.md](RUNBOOK.md), [BOOTSTRAP_SERVER.md](BOOTSTRAP_SERVER.md), [STAFF_ACCOUNT_OPS.md](STAFF_ACCOUNT_OPS.md), [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md), [PRIVATE_LLM_BACKEND.md](PRIVATE_LLM_BACKEND.md), [HEADSCALE_CONTROL_PLANE.md](HEADSCALE_CONTROL_PLANE.md), [REMOTE_HELPER_COMPUTE_CONTROL.md](REMOTE_HELPER_COMPUTE_CONTROL.md), [TROUBLESHOOTING.md](TROUBLESHOOTING.md) |
| Developer | [DEVELOPMENT.md](DEVELOPMENT.md) | [ARCHITECTURE.md](ARCHITECTURE.md), [ENDPOINT_CHECKLIST.md](ENDPOINT_CHECKLIST.md), [PRIVATE_LLM_BACKEND.md](PRIVATE_LLM_BACKEND.md), [OPENAI_HELPER.md](OPENAI_HELPER.md), [CONTRIBUTING_DOCS.md](CONTRIBUTING_DOCS.md), [DECISIONS.md](DECISIONS.md) |
...
- [PRIVATE_LLM_BACKEND.md](PRIVATE_LLM_BACKEND.md) (public LMS + private tailnet helper path)
- [HEADSCALE_CONTROL_PLANE.md](HEADSCALE_CONTROL_PLANE.md) (recommended Headscale control-plane path for createMPLS-style deployments)
- [REMOTE_HELPER_COMPUTE_CONTROL.md](REMOTE_HELPER_COMPUTE_CONTROL.md) (staff-only bounded activation path for expensive remote helper compute)
...
- [OPERATOR_ONBOARDING_DRILL.md](OPERATOR_ONBOARDING_DRILL.md)
...
### Governance and partner context
