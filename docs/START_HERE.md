...
| Developer | [DEVELOPMENT.md](DEVELOPMENT.md) | [ARCHITECTURE.md](ARCHITECTURE.md), [PRIVATE_LLM_BACKEND.md](PRIVATE_LLM_BACKEND.md), [DECISIONS.md](DECISIONS.md) |
...
- [PRIVATE_LLM_BACKEND.md](PRIVATE_LLM_BACKEND.md) (remote GPU / Tailscale helper path)
