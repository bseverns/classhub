...
| Helper policy, response behavior, backend routing | `services/homework_helper/tutor/views.py`, `services/homework_helper/tutor/policy.py`, `services/homework_helper/tutor/engine/service.py`, `services/homework_helper/tutor/engine/context_envelope.py`, `services/homework_helper/tutor/engine/runtime_config.py`, `services/homework_helper/tutor/engine/execution_config.py`, `services/homework_helper/tutor/fixtures/policy_prompts.md` | `python manage.py test tutor.tests.HelperChatAuthTests tutor.tests.test_engine` | `docs/HELPER_POLICY.md`, `docs/OPENAI_HELPER.md`, `docs/DECISIONS.md` |
