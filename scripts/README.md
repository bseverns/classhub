...
| `headscale_restore_rehearsal_evidence.sh` | Runs a Headscale replacement-host restore rehearsal wrapper and captures control-plane recovery evidence plus LMS/model-host manual-check placeholders. |
...
| `coursepack_sdk.py` | Single entry point for local validate/build/package workflows plus static registry index create/validate/list/fetch operations. |
