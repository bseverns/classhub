...
| `headscale_restore_rehearsal_evidence.sh` | Runs a Headscale replacement-host restore rehearsal wrapper and captures control-plane recovery evidence plus LMS/GPU manual-check placeholders. |
