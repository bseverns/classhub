...
HOTSPOT_BUDGETS: dict[Path, int] = {
    ...
    Path("services/classhub/hub/tests/test_teacher_admin_portal_org_access.py"): 40,
    Path("services/classhub/hub/tests/test_teacher_admin_portal_org_access_boundary.py"): 700,
    Path("services/classhub/hub/tests/test_teacher_admin_portal_org_access_rbac_tooling.py"): 1200,
