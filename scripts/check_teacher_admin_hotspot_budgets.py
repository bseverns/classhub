...
HOTSPOT_BUDGETS: dict[Path, int] = {
    ...
    Path("services/classhub/hub/services/org_access_capabilities.py"): 620,
    Path("services/classhub/hub/services/rbac_policy_bundle.py"): 180,
    Path("services/classhub/hub/services/rbac_policy_bundle_normalize.py"): 560,
    ...
    Path("services/classhub/hub/views/teacher_parts/auth_sso_core.py"): 240,
    Path("services/classhub/hub/views/teacher_parts/auth_sso_google_flow.py"): 140,
    Path("services/classhub/hub/views/teacher_parts/content_home_context.py"): 80,
    ...
    Path("services/classhub/hub/views/teacher_parts/content_rbac_view_endpoints.py"): 80,
    Path("services/classhub/hub/views/teacher_parts/content_rbac_view_context.py"): 180,
    Path("services/classhub/hub/views/teacher_parts/content_rbac_view_helpers.py"): 240,
