...
SECTION_BUDGETS: dict[Path, int] = {
    ...
    Path("services/classhub/templates/includes/teach_class/class_setup_roster_section.html"): 50,
    Path("services/classhub/templates/includes/teach_class/class_setup_roster_table.html"): 50,
    Path("services/classhub/templates/includes/teach_class/class_setup_roster_student_row.html"): 100,
    Path("services/classhub/templates/includes/teach_class/class_setup_roster_merge_zone.html"): 60,
    Path("services/classhub/templates/includes/teach_class/class_setup_roster_danger_zone.html"): 50,
    ...
    Path("services/classhub/templates/includes/teach_class/lesson_tracker_release_controls.html"): 85,
    Path("services/classhub/templates/includes/teach_class/lesson_tracker_helper_tuning.html"): 90,
    Path("services/classhub/templates/includes/teach_class/support_board_card.html"): 125,
    ...
    Path("services/classhub/hub/services/teacher_dashboard_sections/outcomes_snapshot.py"): 155,
    Path("services/classhub/hub/services/teacher_dashboard_sections/facilitator_support.py"): 100,
    Path("services/classhub/hub/services/teacher_dashboard_sections/facilitator_support_builders.py"): 225,
